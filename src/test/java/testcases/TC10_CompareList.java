...
public class TC10_CompareList extends TestBase {
    ...
    @Test
    public void addDifferentProductsToWishList() {
        ...
        homePage.clickOn_macbookaddtoCompareList();
        homePage.clickOn_iphoneAddtoCompareList();
        ...
        //softAssert.assertTrue(homePage.successmessage.getText().contains("to your product comparison!"));
